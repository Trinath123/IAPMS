...
import './styles/PreventiveReport.css'
        ...
        return (
            <div className="content-wrapper">
                <div className="x_panel">
                    <div className="x_title" style={{ textAlign: 'center', fontWeight: 'bold', color: 'darkblue', marginTop: 20 }}>Preventive Maintenance Report</div>
