...
import './styles/BreakDownIssues.css'

export default class BreakDownIssues extends Component {
    render() {
        return (
            <div className="content-wrapper">
                ...
                <div className="x_panel">
                    <div className="x_title" style={{ textAlign: 'center', fontSize: 'medium', fontWeight: 'bold', color: 'darkblue' }}>
                        ...
                        <a href className="fa fa-minus pull-right" style={{ fontSize: 17 }} id="aShowCreationScreen" name="CreateTicket" title="Create a Ticket" onclick="ShowCreationScreen();"> </a>
                        <div className="clearfix" />
                    </div>
                    <div className="x_content">
                        <div className="row">
                            <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <table className="table table-striped" style={{ width: '100%' }} id="tblBreakDownMaintenance">
                                    <thead>
                                        <tr>
                                            <th>
                                                Tickets List
                                            ...
                                            <th>
                                                <div className="form-inline">
                                                    <div className="form-group">
                                                        <input id="txtSearchIssuesList" type="text" className="form-control input-sm pull-right" placeholder="search" style={{ width: '75%' }} autoComplete="off" />
                                                    </div>
                                                </div>
                                            </th>
                                        </tr>
                                    ...
                                    <div className="form-horizontal form-label-left">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="form-inline col-md-8 col-sm-8 col-xs-12">
                                                <div className="form-group">
                                                    <select id="ddlBreakdownQuestions" className="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                       
                                      <div id="divDescription" className="form-group">
                                            <label className="control-label col-md-3 col-sm-3 col-xs-12">
                                                Remarks* :
                                          </label>
                                            <div className="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div className="form-group">
                                            <label className="control-label col-md-3 col-sm-3 col-xs-12" />
                                            <div className="col-md-6 col-sm-6 col-xs-12">
                                                <label style={{ color: 'red' }} id="lblIssueCreationStatus" />
                            ...
                            <div id="divIssueDetails">
                                <div className="col-lg-8 col-md-8 col-sm-12 col-xs-12" style={{ borderLeft: '1px solid black' }}>
                                    <div id="divStatus">
                                        ...
                                        <input type="hidden" id="hdnBreakDownID" />
                                        @**@
            <table style={{ marginBottom: 10 }} className="table table-bordered table-striped">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th className="text-right label-custom" style={{ width: '25%' }}>
                                                        Tool ID :
                  </th>
                  ...
                  <button className="btn btn-sm btn-success" id="btnClose" onclick=" CloseStatus();">Verify and Close</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
